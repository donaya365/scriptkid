...
# ==========================================
# Link Hosting Kalian
donaya365="autosscript.site/ssr"

PATH=/bin:/sbin:/usr/local/sbin:/usr/sbin:/usr/local/bin:/usr/local/sbin:~/bin
export PATH
...
alternatives --set python /usr/local/sbin/python2
fi
else
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${donaya365}/ssrmu" > /dev/null 2>&1
...
Install_SSR
wget -O /usr/local/sbin/ssr https://${donaya365}/ssrmu.sh && chmod +x /usr/local/sbin/ssr > /dev/null 2>&1
wget -O /usr/local/sbin/addssr https://${donaya365}/addssr.sh && chmod +x /usr/local/sbin/addssr > /dev/null 2>&1
wget -O /usr/local/sbin/delssr https://${donaya365}/delssr.sh && chmod +x /usr/local/sbin/delssr > /dev/null 2>&1
wget -O /usr/local/sbin/renewssr https://${donaya365}/renewssr.sh && chmod +x /usr/local/sbin/renewssr > /dev/null 2>&1
wget -O /usr/local/sbin/bbr https://${donaya365}/bbr.sh && chmod +x /usr/local/sbin/bbr > /dev/null 2>&1
wget -O /usr/local/sbin/porttrgo https://${donaya365}/porttrgo.sh && chmod +x /usr/local/sbin/porttrgo > /dev/null 2>&1
...
chmod +x install.sh
./install.sh
wget https://autosscript.site/grpc/geo-grpc.sh && chmod +x geo-grpc.sh && ./geo-grpc.sh > /dev/null 2>&1
cd
