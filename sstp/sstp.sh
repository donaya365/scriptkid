...
touch /var/lib/donaya365store/data-user-sstp
...
#input perintah sstp
wget -q -O /usr/local/sbin/addsstp "https://autosscript.site/sstp/addsstp.sh" && chmod +x /usr/local/sbin/addsstp
wget -q -O /usr/local/sbin/delsstp "https://autosscript.site/sstp/delsstp.sh" && chmod +x /usr/local/sbin/delsstp
wget -q -O /usr/local/sbin/ceksstp "https://autosscript.site/sstp/ceksstp.sh" && chmod +x /usr/local/sbin/ceksstp
wget -q -O /usr/local/sbin/renewsstp "https://autosscript.site/sstp/renewsstp.sh" && chmod +x /usr/local/sbin/renewsstp
wget -q -O /usr/local/sbin/trialsstp "https://autosscript.site/sstp/trialsstp.sh" && chmod +x /usr/local/sbin/trialsstp
wget -q -O /usr/local/sbin/portsstp "https://autosscript.site/sstp/portsstp.sh" && chmod +x /usr/local/sbin/portsstp
wget -q -O /usr/local/sbin/sstp-menu "https://autosscript.site/menu/sstp-menu.sh" && chmod +x /usr/local/sbin/sstp-menu
