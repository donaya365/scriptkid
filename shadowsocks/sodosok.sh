...
# Link Hosting Kalian
donaya365="autosscript.site/shadowsocks"
...
cat > /etc/shadowsocks-libev.json <<END
{
    ...
    "mode":"tcp_and_udp",
    "fast_open":true,
    "plugin":"/usr/local/sbin/obfs-local",
...
wget -q -O /usr/local/sbin/addss "https://${donaya365}/addss.sh" && chmod +x /usr/local/sbin/addss
wget -q -O /usr/local/sbin/delss "https://${donaya365}/delss.sh" && chmod +x /usr/local/sbin/delss
wget -q -O /usr/local/sbin/cekss "https://${donaya365}/cekss.sh" && chmod +x /usr/local/sbin/cekss
wget -q -O /usr/local/sbin/renewss "https://${donaya365}/renewss.sh" && chmod +x /usr/local/sbin/renewss
wget -q -O /usr/local/sbin/ss-menu "https://autosscript.site/menu/ss-menu.sh" && chmod +x /usr/local/sbin/ss-menu
sleep 1
