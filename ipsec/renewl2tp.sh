...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/var/lib/donaya365store/data-user-l2tp")
    ...
    echo -e "\E[44;1;39m        ⇱ Renew L2TP User ⇲        \E[0m"
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"		
	grep -E "^### " "/var/lib/donaya365store/data-user-l2tp" | cut -d ' ' -f 2-3 | nl -s ') '
	echo -e "     0) Cancel"
    echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
user=$(grep -E "^### " "/var/lib/donaya365store/data-user-l2tp" | cut -d ' ' -f 2 | sed -n "${CLIENT_NUMBER}"p)
exp=$(grep -E "^### " "/var/lib/donaya365store/data-user-l2tp" | cut -d ' ' -f 3 | sed -n "${CLIENT_NUMBER}"p)
now=$(date +%Y-%m-%d)
d1=$(date -d "$exp" +%s)
d2=$(date -d "$now" +%s)
exp2=$(( (d1 - d2) / 86400 ))
...
sed -i "s/### $user $exp/### $user $exp4/g" /var/lib/donaya365store/data-user-l2tp
clear
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"		
