...
wget -q -O /usr/local/sbin/addl2tp https://autosscript.site/ipsec/addl2tp.sh && chmod +x /usr/local/sbin/addl2tp
wget -q -O /usr/local/sbin/dell2tp https://autosscript.site/ipsec/dell2tp.sh && chmod +x /usr/local/sbin/dell2tp
wget -q -O /usr/local/sbin/addpptp https://autosscript.site/ipsec/addpptp.sh && chmod +x /usr/local/sbin/addpptp
wget -q -O /usr/local/sbin/delpptp https://autosscript.site/ipsec/delpptp.sh && chmod +x /usr/local/sbin/delpptp
wget -q -O /usr/local/sbin/renewpptp https://autosscript.site/ipsec/renewpptp.sh && chmod +x /usr/local/sbin/renewpptp
wget -q -O /usr/local/sbin/renewl2tp https://autosscript.site/ipsec/renewl2tp.sh && chmod +x /usr/local/sbin/renewl2tp
wget -q -O /usr/local/sbin/trialpptp https://autosscript.site/ipsec/trialpptp.sh && chmod +x /usr/local/sbin/trialpptp
wget -q -O /usr/local/sbin/triall2tp https://autosscript.site/ipsec/triall2tp.sh && chmod +x /usr/local/sbin/triall2tp

touch /var/lib/donaya365store/data-user-l2tp > /dev/null 2>&1
touch /var/lib/donaya365store/data-user-pptp > /dev/null 2>&1

wget -q -O /usr/local/sbin/ipsec-menu "https://autosscript.site/menu/ipsec-menu.sh" && chmod +x /usr/local/sbin/ipsec-menu
