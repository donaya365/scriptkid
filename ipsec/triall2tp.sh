...
until [[ $L2TPTrial =~ ^[a-zA-Z0-9_]+$ && ${CLIENT_EXISTS} == '0' ]]; do
		...
		CLIENT_EXISTS=$(grep -w $L2TPTrial /var/lib/donaya365store/data-user-l2tp | wc -l)
...
echo -e "### $L2TPTrial $exp">>"/var/lib/donaya365store/data-user-l2tp"
clear
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"		
echo -e "\E[41;1;39m       ⇱ Trial L2TP Account ⇲      \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"		
echo -e ""
