...
until [[ $PPTPTrial =~ ^[a-zA-Z0-9_]+$ && ${CLIENT_EXISTS} == '0' ]]; do
		...
		CLIENT_EXISTS=$(grep -w $PPTPTrial /var/lib/donaya365store/data-user-pptp | wc -l)
...
echo -e "### $PPTPTrial $exp">>"/var/lib/donaya365store/data-user-pptp"
clear
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"		
echo -e "\E[41;1;39m       ⇱ Trial PPTP Account ⇲      \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"		
echo -e ""
echo -e "Server IP : BUG.$domain"
