...
#wget -q -O /usr/local/xray/xray "https://autosscript.site/core/xray"
#wget -q -O /usr/local/xray/xray "https://autosscript.site/core/xray" 
wget -q -O /usr/local/bin/geosite.dat "https://autosscript.site/grpc/geosite.dat"
wget -q -O /usr/local/bin/geoip.dat "https://autosscript.site/grpc/geoip.dat"
mkdir -p /etc/xray/
...
wget -O addgrpc "https://autosscript.site/grpc/addgrpc.sh"
wget -O delgrpc "https://autosscript.site/grpc/delgrpc.sh"
wget -O renewgrpc "https://autosscript.site/grpc/renewgrpc.sh"
wget -O cekgrpc "https://autosscript.site/grpc/cekgrpc.sh"
chmod +x addgrpc
chmod +x delgrpc
chmod +x renewgrpc
chmod +x cekgrpc
