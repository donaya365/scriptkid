...
BURIQ () {
    curl -sS https://https://raw.githubusercontent.com/donaya365/perizinan/main/main/allow > /root/tmp
...
Name=$(curl -sS https://https://raw.githubusercontent.com/donaya365/perizinan/main/main/allow | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipinfo.io/ip)
    IZIN=$(curl -sS https://https://raw.githubusercontent.com/donaya365/perizinan/main/main/allow | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
cat>/etc/xray/v2ray-$user-tls.json<<EOF
      ...
      "aid": "0",
      "net": "ws",
      "path": "/Whatsapp/087756116610/082339191527/",
      "type": "none",
      "host": "",
      "tls": "tls"
}
...
echo -e " Network        : ws"
echo -e " Path           : /Whatsapp/087756116610/082339191527/"
echo -e " ==================================${off}"
